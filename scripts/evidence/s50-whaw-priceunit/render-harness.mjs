// s50-whaw-priceunit: evaluate app.js's card renderer + JSON-LD in node against a
...
const sum = { totalRows: all.length, loaded: rows.length, visiblePrice: visible.length, jsonLdOffers: rows.filter(r => r.schema.offers).length,
